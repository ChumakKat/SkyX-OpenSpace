...
$mail->Subject = 'Заявка на бронирвание проведения мероприятия в SkyX!';
...
// Тело письам
$body = '<h1>Заявка на бронирование</h1>';
...
if(trim(!empty($time))){
    $body.='<p><strong>Время бронирования:</strong> '.$time.'</p>';
}
if(trim(!empty($date))){
    $body.='<p><strong>Дата бронирования:</strong> '.$date.'</p>';
}
